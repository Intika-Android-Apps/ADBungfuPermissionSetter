...
fun checkRunInBackgroundPermission(pkg: String, appops: String): CompletableFutureCompat<String> {
...
fun setRunInBackgroundPermission(pkg: String, appops: String, setEnabled: Boolean, callback: Callback): CompletableFutureCompat<Boolean> {
...
fun resetRunInBackgroundPermission(pkg: String): CompletableFutureCompat<String> {
    val future = CompletableFutureCompat<String>()
